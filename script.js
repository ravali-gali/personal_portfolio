...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            ...
            $("#favicon").attr("href", "https://res.cloudinary.com/dphkbv1mt/image/upload/v1723359418/sp9ooebdughfst0n0dkz.jpg");
        }
        else {
    ...
    let project_names=["sathish","uma","sandeep","yadhagiri","ai","bhk","restaurant","living","library","hospital","parlour","sketch"];
    ...
    carousel_img(project_restaurant,'restaurant');
